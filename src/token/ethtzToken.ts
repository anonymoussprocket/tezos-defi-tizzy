...
export class ethtzToken implements BaseToken {
    readonly tokenAddress = 'KT19at7rQUvyjxnZ2fBv7D9zc8rkyG7gAoU8';
    readonly tokenType = 'tzip7';
    readonly tokenSymbol = 'ETHtz';
    readonly tokenDecimals = 18;
    readonly tokenLedgerMap = 199;
    readonly tokenLedgerKeyType = 'address';
    readonly tokenLedgerPath = '$.args[0].int';
    readonly tokenApprovalMap = 199;
    readonly tokenApprovalPath = '$.args[1][*].args';
